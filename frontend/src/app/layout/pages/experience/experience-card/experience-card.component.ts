...
export class ExperienceCardComponent implements OnInit, OnChanges {
    ...
    public workDescription = input<TWorkExperience | null>(null);
    public experienceDescription = input<TWorkExperience | TEducationExperience | null>(null);
    ...
    constructor(
        ...
        @Inject(Store) private store: Store<TEducationExperience | TWorkExperience>,
    ) {}
    ...
    public showDialogExperience(dialogInfo: TWorkExperience | TEducationExperience | null) {
        this.store.dispatch(
