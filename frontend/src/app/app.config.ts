...
import { SSRFallbackInterceptor } from '@core/interceptors/ssr-fallback.interceptor';
...
export const appConfig: ApplicationConfig = {
    providers: [
        ...
        // Добавляем провайдер анимаций
            provideAnimationsAsync(),

        // HTTP клиент с DI-based интерцепторами
        ...
        // HTTP Interceptors (оба через DI) - ДОЛЖНЫ БЫТЬ ЗДЕСЬ, а не внутри provideHttpClient
        {
        ...
        {
            provide: HTTP_INTERCEPTORS,
            useClass: SSRFallbackInterceptor,
            multi: true,
        },
