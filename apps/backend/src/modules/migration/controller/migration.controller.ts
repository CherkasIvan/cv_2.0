...
export class MigrationController {
    ...
    @ApiOperation({
        ...
        description:
            'Перенос данных hard skills навигации из Firebase в PostgreSQL',
    })
    @ApiResponse({
        status: 201,
    ...
    @ApiOperation({
        ...
        description:
            'Перенос данных рабочего и образовательного опыта из Firebase в PostgreSQL',
    })
    @ApiResponse({
        status: 201,
    ...
    @ApiOperation({
        ...
        description:
            'Перенос данных боковой панели технологий из Firebase в PostgreSQL',
    })
    @ApiResponse({
        status: 201,
    ...
    @ApiOperation({
        ...
        description:
            'Перенос данных боковой панели опыта из Firebase в PostgreSQL',
    })
    @ApiResponse({
        status: 201,
    ...
    @ApiOperation({
        ...
        description:
            'Перенос данных тематических изображений из Firebase в PostgreSQL',
    })
    @ApiResponse({
        status: 201,
    ...
    @ApiOperation({
        ...
        description:
            'Возвращает список технологий из PostgreSQL с возможностью фильтрации по категории',
    })
    @ApiQuery({
        name: 'category',
        required: false,
    ...
    @ApiOperation({
        ...
        description:
            'Возвращает список боковой панели технологий из PostgreSQL',
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description:
            'Возвращает список информации главной страницы из PostgreSQL',
    })
    @ApiResponse({
        status: 200,
