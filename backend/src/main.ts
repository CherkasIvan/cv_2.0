...
async function bootstrap() {
    ...
    const config = new DocumentBuilder()
        ...
        .setDescription(
            'Комprehensive API для управления портфолио разработчика с миграцией данных из Firebase в PostgreSQL',
        )
        .setVersion('1.0')
    ...
    console.log(`🚀 Приложение запущено на http://localhost:3000/api/v1`);
    console.log(
